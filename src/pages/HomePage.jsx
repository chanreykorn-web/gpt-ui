...
export const Banners = ({ backgroundImage, title, service }) => {
    return (
        <div className="relative bg-gray-500 h-[90vh] w-full">
            ...
            >
                <motion.h1
                    className="text-5xl md:text-5xl font-bold px-4 text-fujiaire-text"
                ...
                {service && (
                    <div className="flex justify-center mt-5">
                        <button
                            className="relative flex px-20 py-4 items-center justify-center overflow-hidden bg-transparent border border-fujiaire rounded-full text-white shadow-2xl transition-all cursor-pointer
...
export const Solutions = () => {
    ...
    return (
        <div className='mt-10' ref={ref1}>
            ...
            <motion.div className="grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-4 gap-15 mt-5"
                variants={fadeVariants}
                initial="hidden"
                animate={isInView1 ? 'visible' : 'hidden'}
            >
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-6 w-full py-10" ref={ref1}>
            ...
            <motion.div
                ...
                style={{
                    backgroundImage: `url(${card1})`, // Change path as needed
        ...
        <div className='mt-5'>
            <div className='mt-10'>
                <div className='flex justify-between items-center gap-5'>
                    ...
                    <a href="" className='hover:text-fujiaire-text inline-block'>View all</a>
                </div>
                <div className='flex items-center gap-2'>
                    <div className='w-[13px] h-[13px] bg-fujiaire-text rounded-4xl' data-aos="fade-left"></div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 mt-10'>
                ...
                <div className="flex justify-center items-center w-full md:mt-0 mt-20"
                    data-aos="fade-up"
                    data-aos-delay="150"
                    data-aos-easing="ease-in-out"
                >
