        ...
        <div>
            ...
            <div className='px-8 py-5 md:px-15'>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <img src={card1} alt="" className=' rounded-2xl w-[579px] h-[365px] object-center' />
                    <GeneralService />
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 mt-15'>
                    <GeneralServiceSection />
                    <img src={card2} alt="" className=' flex justify-end rounded-2xl w-[579px] h-[365px] object-center' />
                </div>
            </div>
            <Testimonials />
            <Footer />
...
export const SectionCarousel = () => {
    return (
        <Carousel
            ...
            className="pb-4"
        >
            <div className='w-[300px] h-[331px] bg-white rounded-2xl'>
